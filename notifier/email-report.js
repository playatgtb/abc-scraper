...
const addScreenshotshotViewer = (screenshotDirs, screenshotDirUrls) => {
  ...
  screenshotDirs.forEach((dir, dirIndex) => {
    fs.readdirSync(dir).forEach((file) => {
      ...
      htmlContent += `<div style="font-size:1.5rem;color:darkgray">${license} ${transfer ? `(transfer)` : ''} | <a style="color:darkgray" href="${mapsUrl}">view map</a> | <a style="color:darkgray" href="${licenseUrl}">view license page</a></div>\n`;
