...
const addScreenshotshotViewer = (screenshotDirs, screenshotDirUrls) => {
  ...
  htmlHead = `
    ...
    .title { display: inline-block; font-size: 2rem; font-weight: bold; padding: 5px 10px; border: 1px solid black; border-radius: 30px; background-color: black; color: white; }
    </style>
  `;
